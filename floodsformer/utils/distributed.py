...
# Modified based on https://github.com/facebookresearch/TimeSformer/blob/main/timesformer/utils/distributed.py
...
def is_master_proc(num_gpus=None):
    """
    Determines if the current process is the master process.
    Args:
        num_gpus (int): number of total gpus (cfg.NUM_GPUS * cfg.NUM_SHARDS).
    """
